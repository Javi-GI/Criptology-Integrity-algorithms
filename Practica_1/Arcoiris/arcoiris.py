...
caracteresCadena = 'abcdefghijklmnopqrstuvwxyz'
...
def main():
    ...
    columnas = [50, 50, 50, 50, 100, 100, 100, 100, 200, 200, 200, 200, 300, 300, 300, 300]
    filas = [5000, 10000, 30000, 50000, 5000, 10000, 30000, 50000, 5000, 10000, 30000, 50000, 5000, 10000, 30000, 50000]
